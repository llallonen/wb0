        ...
        <div className="delivery-wrapper">
          <div className="delivery-pickup delivery-item">
            {state.delivery.address ? (
              <h5 className="delivery-item__col">{state.delivery.title}</h5>
            ) : (
              <h5 className="">Выберите способ доставки</h5>
            )}
            <div>
              {state.delivery.address ? (
                <p className="delivery-adress text">{state.delivery.address}</p>
              ) : (
                <></>
              )}
              {state.delivery.rating ? (
                <div className="stars">
                  <svg
                  ...
                  {state.delivery.rating} {state.delivery.workingHours}
                </div>
              ) : (
                <></>
              )}
